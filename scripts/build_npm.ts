...
await build({
  ...
  package: {
    name: "@coinset/bitbank",
    version: Deno.args[0]?.replace(/^v/, ""),
    description: "Universal Bitbank API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/bitbank.git",
    },
    bugs: {
      url: "https://github.com/coinset/bitbank/issues",
    },
    homepage: "https://github.com/coinset/bitbank#readme",
    funding: {
      type: "patreon",
